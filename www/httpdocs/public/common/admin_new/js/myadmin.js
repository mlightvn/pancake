...
$(function() {
    $(window).bind("load resize", function() {
        ...
        if (width < 1025) {
            ...
            $(".open-close i").removeClass('glyphicon-circle-arrow-left');
            $(".logo span").hide();
        } else {
            $('body').removeClass('content-wrapper');
            // $(".open-close i").addClass('icon-arrow-left-circle');
            $(".open-close i").addClass('glyphicon-circle-arrow-left');
            $(".logo span").show();
        }
    });
...
// Sidebar open close
  $(".open-close").click(function(){
    ...
    $(".open-close i").toggleClass("glyphicon-circle-arrow-left");
    $(".logo span").toggle();
