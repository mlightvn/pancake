    ...
    <style>
        ...
        */
        .jssora05l, .jssora05r {
            ...
            height: 40px;
            cursor: pointer;
            background: url('/common/image/slide/a17.png') no-repeat;
            overflow: hidden;
        }
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 380px; overflow: hidden; visibility: hidden;">
        <!-- Loading Screen -->
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 380px; overflow: hidden;">
            ...
            <div data-p="112.50" style="display: none;">
                <a href="https://www.sendo.vn/thoi-trang-nu/set-trang-phuc/?is_event=1" target="_blank">
                <img data-u="image" src="https://media3.scdn.vn/img2/2016/10_11/cLsFIV_simg_eb4789_440x440_maxb.png" alt="Sendo: SET TRANG PHỤC NỮ ĐẸP" />
                </a>
            </div>
            <div data-p="112.50" style="display: none;">
                ...
                <img data-u="image" src="https://static.nguyenkimmall.com/images/companies/_1/Design/banner/img-thang-nhat-ban-1.png" alt="Nguyễn Kim: KHUYẾN MÃI CHƯƠNG TRÌNH LỄ HỘI NHẬT BẢN" />
                </a>
            </div>
